...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="NotEmpty" runat="server" ErrorMessage="Fältet får inte lämnas tomt" ControlToValidate="FirstTemp" Display="Dynamic" Text="*"></asp:RequiredFieldValidator>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="NotEmpty3" runat="server" ErrorMessage="Fältet får inte lämnas tomt" ControlToValidate="ThirdTemp" Text="*"></asp:RequiredFieldValidator>
